...
//!
//! The shell asks for it through `linboard_shell_v1.set_output_overview` when
//! its guide menu opens. While it is on, [`crate::render::output_elements`]
//! draws each window scaled into a card slot from
//! [`linboard_protocol::overview`] instead of at its real geometry; this
...
use linboard_protocol::overview::{spring, Rect, CARD_SPRING};
...
const FLIGHT: Duration = linboard_protocol::overview::FLIGHT;
