...
//!
//! Which clients may bind them is the same question `lxb_shell_v1`
...
pub fn advertise(display: &DisplayHandle) {
    ...
    InputMethodManagerState::new::<LxbState, _>(display, |_client| true);
    VirtualKeyboardManagerState::new::<LxbState, _>(display, |_client| true);
}
